        ...
        function optiCurve(path) {
            function opti_penalty(path, i, j, res, opttolerance, convc, areac) {
                ...
                for (var k_2 = mod(i + 1, m), k1_1; k_2 !== j; k_2 = k1_1) {
                    ...
                    var pt_1 = bezier(t_1, p0, p1, p2, p3);
                    var d_1 = ddist(vertex[k_2], vertex[k1_1]);
                    if (d_1 === 0.0) {
                        return true;
                    }
                    var d1 = dpara(vertex[k_2], vertex[k1_1], pt_1) / d_1;
                    if (Math.abs(d1) > opttolerance) {
                        return true;
                    }
                    if (iprod(vertex[k_2], vertex[k1_1], pt_1) < 0 ||
                        iprod(vertex[k1_1], vertex[k_2], pt_1) < 0) {
                        return true;
                    }
                    res.pen += d1 * d1;
                }
                for (var k_3 = i, k1_2; k_3 !== j; k_3 = k1_2) {
                    ...
                    var pt_2 = bezier(t_2, p0, p1, p2, p3);
                    var d_2 = ddist(curve.c[k_3 * 3 + 2], curve.c[k1_2 * 3 + 2]);
                    if (d_2 === 0.0) {
                        return true;
                    }
                    var d1 = dpara(curve.c[k_3 * 3 + 2], curve.c[k1_2 * 3 + 2], pt_2) / d_2;
